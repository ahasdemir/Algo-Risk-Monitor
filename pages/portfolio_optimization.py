...
st.set_page_config(
    page_title="Portfolio Optimization using Efficient Frontier",
    page_icon="📈"
)

st.header("Portfolio Optimization using Efficient Frontier")
st.write("Optimize your portfolio using the Efficient Frontier method with Monte Carlo simulations.")
tickers = st.multiselect("Select Stocks for Portfolio Optimization", snp500_tickers, default=["AAPL", "MSFT", "GOOGL"])
num_portfolios = st.number_input("Number of Portfolios to Simulate", min_value=100, max_value=10000, value=1000)
...
if st.button("Optimize Portfolio"):
    ...
    fig, max_sharpe_portfolio, min_vol_portfolio = efficient_frontier_analysis_with_monte_carlo(
        stock_data,
