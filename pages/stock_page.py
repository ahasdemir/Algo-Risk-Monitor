...
ticker = st.selectbox("Select Stock Ticker", snp500_tickers, index=snp500_tickers.index("AAPL"))
period = st.selectbox("Select Period", ["1mo", "3mo", "6mo", "1y", "2y", "5y", "10y", "max"], index=5)
